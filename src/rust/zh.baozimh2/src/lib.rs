...
impl Source for Baozimh2Source {
	fn new() -> Self {
		Self
	}
...
impl ListingProvider for Baozimh2Source {
...
impl ImageRequestProvider for Baozimh2Source {
...
register_source!(Baozimh2Source, ListingProvider, ImageRequestProvider);
